                              ...
                              children: [
                                ...
                                TitleWithTextfield(
                                  ...
                                  onChanged: (value) {
                                    if (value == null || value.isEmpty) {
                                      controller.showErrorMessageAmount.value =
                                          true;
                                ...
                                TitleWithTextfield(
                                  ...
                                  textEditingController: controller
                                      .familyEventSelectController.value,
                                  showErrorMessage: controller
                                      .showErrorMessageevent, // Pass RxBool here
                                  onChanged: (value) {
                                    if (value == null || value.isEmpty) {
                                      controller.showErrorMessageevent.value =
                                          true;
                                      return 'Name cannot be empty';
                                    }
                                    controller.showErrorMessageevent.value =
                                      ...
                                      () => SelectFilter(
                                        onTap: () {
                                          controller.isSelectedFamily.value =
                                              index;
                                          controller.familyEventSelectController
                                                  .value.text =
                                              controller.eventSelect[index];
                                        },
                                        isSelecte: index ==
                                                controller
                                                    .isSelectedFamily.value
                                            ? true
                                            : false,
                                ...
                                TitleWithTextfield(
                                  ...
                                  textEditingController: controller
                                      .relationShipSelectController.value,
                                  onChanged: (inputText) {
                                    controller.isSelectedRelation.value = -1;
                                  },
                                ),
                                ...
                                Container(
                                  ...
                                  child: ListView.builder(
                                    shrinkWrap: true,
                                    itemCount:
                                        controller.relationshipSelect.length,
                                    padding:
                                        EdgeInsets.symmetric(vertical: 2.h),
                                    itemBuilder: (context, index) => Obx(
                                      () => SelectFilter(
                                        onTap: () {
                                          controller.isSelectedRelation.value =
                                              index;
                                          controller
                                                  .relationShipSelectController
                                                  .value
                                                  .text =
                                              controller
                                                  .relationshipSelect[index];
                                        },
                                        isSelecte: index ==
                                                controller
                                                    .isSelectedRelation.value
                                            ? true
                                            : false,
                                        title: controller
                                            .relationshipSelect[index],
